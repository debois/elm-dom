...
offsetWidth = field "offsetWidth" Decode.float
...
offsetHeight = field "offsetHeight" Decode.float
...
offsetLeft = field "offsetLeft" Decode.float
...
offsetTop = field "offsetTop" Decode.float
...
scrollLeft = field "scrollLeft" Decode.float
...
scrollTop = field "scrollTop" Decode.float
